...
public class DigestDemo1 {
    ...
    private static void md5ToHexSting16() throws NoSuchAlgorithmException {
...
//        System.out.println(Base64.encode(digest));
    ...
    private static void md5Base64() throws NoSuchAlgorithmException {
        // 原文
        String input = "aa";
        // 算法
        String algorithm = "MD5";
